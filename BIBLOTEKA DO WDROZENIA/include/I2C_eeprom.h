...
private:
  ...
  void     _buildAddressPrefix(const uint16_t memoryAddress, uint8_t &address, uint8_t *prefix, uint8_t &prefixLen);
  ...
  bool     _isWriteWindowReady() const;
  ...
  uint16_t _transactionTimeoutMs = 2;
