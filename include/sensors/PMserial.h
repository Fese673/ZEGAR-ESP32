...
protected:
  ...
  void waitNonBlocking(uint16_t wait_ms);  // non-blocking wait for ESP32

  // message timing
  #ifdef ESP32
  static const uint16_t max_wait_ms = 300;  // reduced timeout for non-blocking operation on ESP32
  #else
